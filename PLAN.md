...
- [ ] Let any thread request targeted font-glyph clear without touching backend state directly.
...
- [ ] Use `send` for retain/release messages so important cache-control events are not dropped.
