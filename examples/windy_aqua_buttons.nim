...
proc aquaPalette(kind: AquaButtonKind): AquaButtonPalette =
  ...
  of abkNormal:
    AquaButtonPalette(
      rimTop: rgba(122, 126, 128, 118),
      rimMid: rgba(218, 224, 225, 100),
      rimBottom: rgba(142, 150, 152, 98),
      rimStroke: rgba(86, 88, 94, 118),
      innerTop: rgba(228, 234, 236, 122),
      innerMid: rgba(192, 201, 204, 110),
      innerBottom: rgba(238, 246, 248, 116),
      topShade: rgba(48, 58, 64, 28),
      waistShade: rgba(80, 94, 102, 20),
      lowerWash: rgba(255, 255, 255, 28),
      sideShade: rgba(54, 64, 70, 14),
      bottomGlow: rgba(255, 255, 255, 68),
  ...
  of abkDefault:
    AquaButtonPalette(
      rimTop: rgba(76, 68, 166, 138),
      rimMid: rgba(112, 164, 211, 118),
      rimBottom: rgba(128, 159, 168, 110),
      rimStroke: rgba(60, 55, 150, 124),
      innerTop: rgba(190, 211, 234, 114),
      innerMid: rgba(138, 178, 236, 108),
      innerBottom: rgba(188, 233, 253, 114),
      topShade: rgba(0, 44, 126, 32),
      waistShade: rgba(0, 64, 152, 22),
      lowerWash: rgba(255, 255, 255, 22),
      sideShade: rgba(0, 52, 132, 14),
      bottomGlow: rgba(232, 255, 255, 64),
...
proc addAquaButton(
  ...
  let innerClip = renders.addRect(
    ...
    shadows = [
      RenderShadow(
        ...
        x: 0.0'f32,
        y: 1.2'f32,
        fill: rgba(0, 0, 0, if kind == abkDefault: 26'u8 else: 22'u8).color,
      ),
      RenderShadow(
        style: InnerShadow,
        blur: 2.0'f32,
        ...
        x: 0.0'f32,
        y: -1.0'f32,
        fill: rgba(255, 255, 255, if kind == abkDefault: 68'u8 else: 58'u8).color,
      ),
      RenderShadow(
        style: InnerShadow,
        blur: 7.0'f32,
  ...
  discard renders.addRect(
    ...
    shadows = [
      RenderShadow(
        ...
        x: 0.0'f32,
        y: 1.0'f32,
        fill: rgba(255, 255, 255, if kind == abkDefault: 36'u8 else: 30'u8).color,
      ),
      RenderShadow(
        style: DropShadow,
        blur: 5.0'f32,
        ...
        fill: rgba(
          ...
          p.innerTop.g,
          p.innerTop.b,
          if kind == abkDefault: 38'u8 else: 30'u8,
        ).color,
      ),
      RenderShadow(),
      RenderShadow(),
    ...
    shadows = [
      RenderShadow(
        ...
        fill: rgba(
          ...
          p.waistShade.g,
          p.waistShade.b,
          if kind == abkDefault: 30'u8 else: 24'u8,
        ).color,
      ),
      RenderShadow(
        style: DropShadow,
        ...
        x: 0.0'f32,
        y: -1.2'f32,
        fill: rgba(255, 255, 255, if kind == abkDefault: 14'u8 else: 12'u8).color,
      ),
      RenderShadow(),
      RenderShadow(),
    ],
  ...
  discard renders.addRect(
    ...
    linear(
      rgba(255, 255, 255, 0),
      p.lowerWash,
      rgba(p.bottomGlow.r, p.bottomGlow.g, p.bottomGlow.b, 44),
      axis = fgaY,
      midPos = 164'u8,
    ),
    innerRadius,
    ...
    shadows = [
      RenderShadow(
        ...
        fill: rgba(
          ...
          p.bottomGlow.g,
          p.bottomGlow.b,
          if kind == abkDefault: 36'u8 else: 26'u8,
        ).color,
      ),
      RenderShadow(
        style: DropShadow,
